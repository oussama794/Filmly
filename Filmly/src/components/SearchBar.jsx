      ...
      <div className="relative flex items-center gap-2">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 bg-gray-800 text-white rounded-lg border border-gray-700 focus:outline-none focus:ring-2 focus:ring-[#f6ad55] focus:border-transparent"
          />
        </div>
        ...
        {showFilter && (
          <button
            ...
            className="bg-[#f6ad55] text-black p-3 rounded-lg hover:opacity-90 transition"
          >
            <Filter size={20} />
          </button>
        )}
